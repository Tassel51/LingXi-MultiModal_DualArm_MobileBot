...
class RealSenseCamera:
    ...
    def connect(self):
        ...
        if (self.device_id == "036522073097"):
            config.enable_stream(rs.stream.accel, rs.format.motion_xyz32f, 63)  # 加速度计
        ...
        # self.int = depth_profile.as_video_stream_profile().intrinsics
    ...
    def get_image_bundle(self):
        ...
        }, depth_intrin, aligned_depth_frame

    def get_imu_data(self):
        imu_frames = self.pipeline.wait_for_frames()
    ...
    def plot_image_bundle(self):
        images, depth_intrin, aligned_depth_frame = self.get_image_bundle()
